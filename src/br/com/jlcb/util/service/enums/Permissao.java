package br.com.jlcb.util.service.enums;
...
public enum Permissao {
	...
	BAIXA_ACESSAR("BAIXA_ACESSAR", "Baixa de título - Acessar"), BAIXA_NOVO("BAIXA_NOVO", "Baixa de título - Novo"),
	BAIXA_EDITAR("BAIXA_EDITAR", "Baixa de título - Editar"),
	BAIXA_EXCLUIR("BAIXA_EXCLUIR", "Baixa de título - Excluir"),

	CIDADE_ACESSAR("CIDADE_ACESSAR", "Cidade - Acessar"), CIDADE_NOVO("CIDADE_NOVO", "Cidade - Novo"),
	CIDADE_EDITAR("CIDADE_EDITAR", "Cidade - Editar"), CIDADE_EXCLUIR("CIDADE_EXCLUIR", "Cidade - Excluir"),
	...
	COMISSAO_ACESSAR("COMISSAO_ACESSAR", "Comissão - Acessar"), COMISSAO_NOVO("COMISSAO_NOVO", "Comissão - Novo"),
	COMISSAO_EDITAR("COMISSAO_EDITAR", "Comissão - Editar"), COMISSAO_EXCLUIR("COMISSAO_EXCLUIR", "Comissão - Excluir"),

	CLIENTE_ACESSAR("CLIENTE_ACESSAR", "Cliente - Acessar"), CLIENTE_NOVO("CLIENTE_NOVO", "Cliente - Novo"),
	CLIENTE_EDITAR("CLIENTE_EDITAR", "Cliente - Editar"), CLIENTE_EXCLUIR("CLIENTE_EXCLUIR", "Cliente - Excluir"),
	...
	FILIAL_ACESSAR("FILIAL_ACESSAR", "Filial - Acessar"), FILIAL_NOVO("FILIAL_NOVO", "Filial - Novo"),
	FILIAL_EDITAR("FILIAL_EDITAR", "Filial - Editar"), FILIAL_EXCLUIR("FILIAL_EXCLUIR", "Filial - Excluir"),
	...
	PRODUTO_ACESSAR("PRODUTO_ACESSAR", "Produto - Acessar"), PRODUTO_NOVO("PRODUTO_NOVO", "Produto - Novo"),
	PRODUTO_EDITAR("PRODUTO_EDITAR", "Produto - Editar"), PRODUTO_EXCLUIR("PRODUTO_EXCLUIR", "Produto - Excluir"),

	SERIE_ACESSAR("SERIE_ACESSAR", "Serie - Acessar"), SERIE_NOVO("SERIE_NOVO", "Serie - Novo"),
	SERIE_EDITAR("SERIE_EDITAR", "Serie - Editar"), SERIE_EXCLUIR("SERIE_EXCLUIR", "Serie - Excluir"),

	TITULO_ACESSAR("TITULO_ACESSAR", "Título - Acessar"), TITULO_NOVO("TITULO_NOVO", "Título - Novo"),
	TITULO_EDITAR("TITULO_EDITAR", "Título - Editar"), TITULO_EXCLUIR("TITULO_EXCLUIR", "Título - Excluir"),

	VENDEDOR_ACESSAR("VENDEDOR_ACESSAR", "Vendedor - Acessar"), VENDEDOR_NOVO("VENDEDOR_NOVO", "Vendedor - Novo"),
	VENDEDOR_EDITAR("VENDEDOR_EDITAR", "Vendedor - Editar"), VENDEDOR_EXCLUIR("VENDEDOR_EXCLUIR", "Vendedor - Excluir"),
	...
	private Permissao(String id, String descricao) {
		this.id = id;
	...
	public static List<Permissao> getListPermissaos() {
